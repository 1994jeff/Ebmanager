	...
	<script type="text/javascript">
		...
		function postAjax(name){
			$.ajax({
				...
				url : '${pageContext.request.contextPath}/business/queryBusiness.do',
		...
		function appendHtml(business){
			...
			html += "<td>1</td>";
			html += "<td>"+business.no+"</td>";
			html += "<td>"+business.name+"</td>";
			if(business.level==0)
			{
				html += "<td>一般商户</td>";
			}else if(business.level==1){
				html += "<td>小商户</td>";
			}else if(business.level==2){
				html += "<td>旗舰店</td>";
			}
			html += "<td>"+business.type+"</td>";
			html += "<td>"+business.phone+"</td>";
// 			html += "<td>"+getFormatDates(business.createTime,5)+"</td>";
			return html;
		}
